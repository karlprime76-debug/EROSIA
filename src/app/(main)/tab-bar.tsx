...
import { Compass, Heart, MessageCircle, Bell, User, MoreHorizontal } from 'lucide-react'
...
const tabs = [
  ...
  { href: '/messages', icon: MessageCircle, key: 'nav_messages' as const },
  { href: '/notifications', icon: Bell, key: 'nav_activity' as const },
            ...
            >
              <div className="relative z-10">
                <MoreHorizontal
                  size={21}
                  strokeWidth={1.8}
                  className="text-[var(--text-muted)] group-hover:text-[var(--text-secondary)] transition-all duration-300"
                />
              </div>
              <span className="relative z-10 text-[9px] font-semibold tracking-wider uppercase text-[var(--text-muted)] group-hover:text-[var(--text-secondary)] transition-colors duration-300">
                {t('nav_more')}
              </span>
            </button>
          </div>
